...
func _register() -> void:
	...
	_equip("Iron Shield",  "shield", false, "defense", 3, 4,  "none", 0, 0.0, "A sturdy iron shield.",  65)
	...
	_equip("Weeping Bark Shield","shield", false, "defense", 4,  7,  "none",           0,    0.0,  "Carved from ancient wood.",     85)
	...
	_equip("Crested Shield",  "shield", false, "defense", 7,  10,  "none", 0, 0.0, "Bears a forgotten crest.",       150)
