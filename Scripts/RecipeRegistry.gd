...
func _ready() -> void:
	recipes = [
		...
		_make("Death Brew",        {"Deathbloom": 2, "Gloomcap": 1},                        "Death Brew",        "heal", 70),
		_make("Shadow Tonic",      {"Voidleaf": 2, "Bloodroot": 1},                         "Shadow Tonic",      "heal", 90),
		_make("Nightshade Elixir", {"Nightshade": 1, "Deathbloom": 1, "Wild Herb": 2},      "Nightshade Elixir", "heal", 110),
